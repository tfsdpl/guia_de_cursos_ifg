...
from djangocore.tests.test_case import BaseTestCase, replace_none_values_in_dictionary
from djangocore.apps.cadastro.models import Fornecedor, Produto
from djangocore.apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from djangocore.apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
