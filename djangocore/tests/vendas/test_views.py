...
from djangocore.tests.test_case import BaseTestCase
from djangocore.apps.cadastro.models import Cliente
from djangocore.apps.vendas.models import CondicaoPagamento, OrcamentoVenda, PedidoVenda
